...
[ -d "resolution/$file" ] || mkdir resolution/$file
...
osmatch=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"name": ' | awk -F'"name": "' '{ print $2 }' | awk -F'"' '{ print $1 }' | head -1)
if [[ "${osmatch[0]}" == *"Windows"* ]]; then 
  scriptoutput="resolution/${file}/ComplianceScript.bat"
else
  scriptoutput="resolution/${file}/ComplianceScript.sh"
fi
sugestionoutput="resolution/${file}/ComplianceSugestions.txt"

#VJN 11/13/2020 10:17 am - This section grabs information from the json report generated for the machine
ports=$(cat reports/$timedirectory/json/${file}.json | grep -ia "number" | awk -F'"number": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
ports=($(echo $ports | tr "\n" "\n"))
protocal=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"protocal": ' | awk -F'"protocal": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
protocal=($(echo $protocal | tr "\n" "\n"))
defenderstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"defender": ' | awk -F'"defender": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
mcafeestatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"mcafee": ' | awk -F'"mcafee": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
nortonstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"norton": ' | awk -F'"norton": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
kaperskystatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"kapersky": ' | awk -F'"kapersky": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
ciscoampstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"ciscoamp": ' | awk -F'"ciscoamp": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
selinuxstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"selinux": ' | awk -F'"selinux": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
firewalldstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"firewalld": ' | awk -F'"firewalld": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
iptablesstatus=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"iptables": ' | awk -F'"iptables": "' '{ print $2 }' | awk -F'"' '{ print $1 }')
drivename=$(cat reports/$timedirectory/json/${file}.json | grep -ia '"name": ' | awk -F'"name": "' '{ print $2 }' | awk -F'"' '{ print $1 }' | tail -1)
